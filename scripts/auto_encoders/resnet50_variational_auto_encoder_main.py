...
from svlearn.auto_encoders.resnet_variational_auto_encoder import ResNetVariationalAutoEncoder
...
if __name__ == "__main__":
    ...
    model = ResNetVariationalAutoEncoder().to(device)
    
    checkpoint_file = f'{results_dir}/trees_resnet50_variational_autoencoder.pt'
